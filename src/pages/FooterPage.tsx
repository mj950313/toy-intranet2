    ...
    <footer className="text-myorange py-4 mt-[40px] mb-[40px]">
      <div className="container mx-auto px-[140px] gap-[40px] flex justify-center items-center">
        <div className="flex items-center">
          ...
          <span className="mx-2">&copy; {new Date().getFullYear()} Toyproject Co. </span>
        </div>
        ...
        <div className="flex space-x-4">
          <a href="https://github.com/mj950313/toy-intranet2" target="_blank" rel="noopener noreferrer">
            <img src="src/images/gitlogo.svg" alt="Team Five github" className="w-10 h-10 mr-2"/>
          </a>
        </div>
      </div>
    </footer>
